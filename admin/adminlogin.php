 ...
 if(isset($_POST['btn-login']))
{
	...
	$pwd=$_POST['pwd'];
	$res=pg_query($dbconn,"SELECT * FROM admin WHERE username='$username'");
	...
	echo '
			...
			<meta http-equiv="refresh" content="3;url=adminsingin.html">
			</head>
			<body >
						...
						<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
						  ...
						  <li class="dropdown-submenu">
							...
							<ul class="dropdown-menu">
							  <li><a tabindex="-1" href="Adminsingin.html">Connexion Manager</a></li>
	...
	<div class="container" id="homepage">
		<h1>Opps</h1>
		<p>Mauvais nom dutilisateur ou mauvais mot de passe, attendez 3s ou <a href="Adminsingin.html">cliquez sur le bouton retour!</a></p>
	</div>
